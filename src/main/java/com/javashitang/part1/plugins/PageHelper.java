...
public class PageHelper {
    ...
    public static final Pattern invalidSql =
            Pattern.compile("(^ *[^(select )].*)|(.* (limit|offset) .*)", Pattern.CASE_INSENSITIVE);
     ...
     * 构建查询总数的sql
     */
    protected static String buildPageCountSql(final String originSql) {
